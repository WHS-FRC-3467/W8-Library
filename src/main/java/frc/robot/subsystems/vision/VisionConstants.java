...
public class VisionConstants {
    ...
    public static CameraConstants[] cameraConstants = new CameraConstants[] {
            new CameraConstants("camera_0",
                new Transform3d(0.2, 0.0, 0.2, new Rotation3d(0.0, -0.4, 0.0)),
                1.0),
            new CameraConstants("camera_1",
            ...
            case SIM:
                return new Vision(
                    ...
                    new VisionIOPhotonVisionSim(
                        () -> drive.getPose(),
                        cameraConstants[0].name,
                        cameraConstants[0].robotToCamera,
