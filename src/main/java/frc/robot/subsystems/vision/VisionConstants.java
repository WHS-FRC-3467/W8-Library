 ...
 *
 * <p>
 * Contains camera calibration data, mounting positions, and factory methods for
 * creating vision
 * cameras. Each camera has:
 *
 * <ul>
 * <li>Extrinsics: Physical mounting transform (position and orientation on
 * robot)
 ...
 *
 * <p>
 * Camera intrinsics should be recalibrated when cameras are changed or
 * remounted. Use
...
public class VisionConstants {
    ...
    // FRONT_LEFT = 001
    public static final Matrix<N3, N3> FRONT_LEFT_MATRIX = MatBuilder.fill(
            Nat.N3(),
            Nat.N3(),
            1380.531127613026,
            0.0,
    ...
    // LEFT = 002
    public static final Matrix<N3, N3> LEFT_MATRIX = MatBuilder.fill(
            Nat.N3(),
            Nat.N3(),
            2000.0032334309244,
            0,
    ...
    // RIGHT = 004
    public static final Matrix<N3, N3> RIGHT_MATRIX = MatBuilder.fill(
            Nat.N3(),
            Nat.N3(),
            1999.9919360266583,
            0,
    ...
    // FRONT_RIGHT = 003
    public static final Matrix<N3, N3> FRONT_RIGHT_MATRIX = MatBuilder.fill(
            Nat.N3(),
            Nat.N3(),
            1994.3346993932607,
            0,
    ...
    public static final CameraProperties FRONT_LEFT = new CameraProperties(
            FRONT_LEFT_NAME,
    ...
    public static final CameraProperties LEFT = new CameraProperties(
            LEFT_NAME,
            LEFT_TRANSFORM,
            LEFT_MATRIX,
            LEFT_DIST_COEFFS,
    ...
    public static final CameraProperties RIGHT = new CameraProperties(
            RIGHT_NAME,
            RIGHT_TRANSFORM,
            RIGHT_MATRIX,
            RIGHT_DIST_COEFFS,
    ...
    public static final CameraProperties FRONT_RIGHT = new CameraProperties(
            FRONT_RIGHT_NAME,
    ...
    private static final VisionIOC2.C2Config FRONT_LEFT_C2_CONFIG = VisionIOC2.defaultsFor(FRONT_LEFT_CAMERA_INDEX);
    private static final VisionIOC2.C2Config LEFT_C2_CONFIG = VisionIOC2.defaultsFor(LEFT_CTWO_CAMERA_INDEX);
    private static final VisionIOC2.C2Config RIGHT_C2_CONFIG = VisionIOC2.defaultsFor(RIGHT_CTWO_CAMERA_INDEX);
    private static final VisionIOC2.C2Config FRONT_RIGHT_C2_CONFIG = VisionIOC2.defaultsFor(FRONT_RIGHT_CAMERA_INDEX);
    ...
    /**
     * Creates and configures a VisionSubsystem with AprilTag cameras based on the
     * current robot
     * mode. Instantiates cameras with appropriate IO implementations (real, sim, or
     * replay).
     */
