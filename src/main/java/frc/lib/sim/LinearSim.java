...
public class LinearSim extends MechanismSim {
  ...
  protected final ElevatorSim simMechanism;
  ...
  public void setVoltage(Voltage voltage) {
    simMechanism.setInputVoltage(voltage.in(Units.Volts));
  }
  ...
  public AngularVelocity getVelocity() {
    return converter
        .toAngle(Units.Meters.of(simMechanism.getVelocityMetersPerSecond()))
        .per(Units.Second);
  }

  @Override
  public Angle getPosition() {
    return converter.toAngle(Units.Meters.of(simMechanism.getPositionMeters()));
  }

  @Override
  public Current getStatorCurrent() {
    return Units.Amps.of(simMechanism.getCurrentDrawAmps());
  }

  @Override
  protected void update(Time deltaTime) {
    simMechanism.update(deltaTime.in(Units.Second));
  }

  @Override
  public void setState(Angle angle, AngularVelocity velocity) {
    simMechanism.setState(
