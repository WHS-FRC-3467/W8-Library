...
public interface Vectorf<T> {
     ...
     *
     * <p>If a tolerance of less than zero is provided then an IllegalArgumentException is thrown.
     *
     * @param v The vector to compare to
     * @param tolerance The value which both components of each vector must be less than to be
     *     considered equal
    ...
    /**
     * Return a vector which is the result of component-wise division of by the given scalar value.
     * This vector remains unchanged.
     *
     * @param value The value to divide each component of this vector by.
     * @return A vector which is the result of dividing each component of this vector by the
     *     provided argument.
     */
     ...
     *
     * <p>The {@code minus} method does not modify 'this' vector.
     *
     * @param v The vector to subtract.
     * @return A vector which is the result of component-wise subtraction of the provided Vec2f from
     *     this vector
     */
    T minus(T v);
     ...
     *
     * <p>Note: This vector itself is normalised and returned, not a copy / clone.
     *
    ...
    /**
     * Return a T which is the result of multiplying this this T by a scalar value. This T remains
     * unchanged.
     *
