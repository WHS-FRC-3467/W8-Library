package frc.lib.util.caliko.utils;
 ...
 *
 * <p>The Mat4f class contains 16 public member properties m00 through m15 which are <strong>column
 * major</strong>, so our matrix looks like this:
 *
 * <p>m00 m10 m20 m30
 *
 * <p>m01 m11 m21 m31
 ...
 * <p>m03 m13 m23 m33
 *
 * <p>For each property the first digit is the column, and the second digit is the row.
 *
 * <p>The identity matrix specifies a left-handed coordinate system whereby if you put your left
 ...
 *
 * <ul>
 *   <li>The direction of the middle finger is the positive X-axis,
 *   <li>The direction of the index finger is the positive Y-axis, and
 *   <li>The direction of the thumb is the positive Z-axis.
 * </ul>
 *
 * <p>This corresponds to the coordinate system used by OpenGL.
 *
 * <p>Rotations are performed in accordance with the right-hand rule, that is, if you were to grip
 * an axis with your thumb pointing towards the positive end of the axis, rotating in a positive
 * direction would follow the curl of your fingers in an anti-clockwise direction, and rotation by a
 * negative amount would go in the opposite (clockwise) direction.
 *
 * @author Al Lansley
...
public class Mat4f {
     ...
     * Default constructor.
     *
     * <p>All member properties are implicitly set to zero by Java as that is the default value of a
     * float primitive.
     */
    public Mat4f() {}
     ...
     * Copy constructor.
     *
     * <p>Copies all properties from the source matrix into the newly constructed matrix.
     *
     ...
     *
     * <p>The matrix is set a column at a time, so the first four floats from the source array are
     * set on m0 to m03, the next four on m10 to m13 and so on.
     *
     * <p>If the source array is not an array of precisely 16 floats then a IllegalArgumentException
     * is thrown.
     *
     ...
     *
     * <p>Sets the provided value diagonally across the matrix. For example, to create an identity
     * matrix with 1.0f across the diagonal then you can call:
     *
     * <p>{@code Mat4f m = new Mat4f(1.0f)}
     *
     * <p>Which will result in a matrix with the following properties:
     *
    ...
    public Mat4f(float value) {
        ...
        // All other values are implicitly set to zero by Java as that is the default value of a
        // float primitive.
    }
     ...
     *
     * <p>The matrix is set as follows:
     *
     * <p>1.0f 0.0f 0.0f 0.0f
     *
     * <p>0.0f 1.0f 0.0f 0.0f
     ...
     *
     * <p>The x-basis is the orientation of the x-axis, as held by the m00, m01 and m02 properties.
     *
     ...
     * <p>The x-basis is the orientation of the x-axis, as held by the m00, m01 and m02 properties.
     *
     * <p>This method is provided to allow for interoperability for users who do not want to use the
     * {@link Vec3f} class.
     *
     ...
     * <p>The x-basis is the orientation of the x-axis, as held by the m00, m01 and m02 properties.
     *
     * <p>To ensure the legality of the x-basis, the provided Vec3f is normalised if required before
     * being set.
     *
     * <p>If you wish to use this class for storing matrices which do not represent a rotation
     * matrix then you should avoid the setXBasis/setYBasis/setZBasis methods and instead set the
     * matrix properties via other methods which accept a float array and do not attempt to enforce
     ...
     * <p>The x-basis is the orientation of the x-axis, as held by the m00, m01 and m02 properties.
     *
     * <p>To ensure the legality of the x-basis, the provided array is converted into a Vec3f and
     * normalised (if required) before being set.
     *
     * <p>If you wish to use this class for storing matrices which do not represent a rotation
     * matrix then you should avoid the setXBasis/setYBasis/setZBasis methods and instead set the
     * matrix properties via other methods which do not enforce normalisation such as the {@link
     * #setFromArray(float[])} and {@link #Mat4f(float[])} methods.
     *
     ...
     *
     * <p>The y-basis is the orientation of theyx-axis, as held by the m10, m11 and m12 properties.
     *
     ...
     *
     * <p>The y-basis is the orientation of the y-axis, as held by the m10, m11 and m12 properties.
     *
     * <p>This method is provided to allow for interoperability for users who do not want to use the
     * {@link Vec3f} class.
     *
     ...
     * <p>The y-basis is the orientation of the y-axis, as held by the m10, m11 and m12 properties.
     *
     * <p>To ensure the legality of the y-basis, the provided Vec3f is normalised if required before
     * being set.
     *
     * <p>If you wish to use this class for storing matrices which do not represent a rotation
     * matrix then you should avoid the setXBasis/setYBasis/setZBasis methods and instead set the
     ...
     * <p>The y-basis is the orientation of the y-axis, as held by the m10, m11 and m12 properties.
     *
     * <p>To ensure the legality of the y-basis, the provided array is converted into a Vec3f and
     * normalised (if required) before being set.
     *
     * <p>If you wish to use this class for storing matrices which do not represent a rotation
     * matrix then you should avoid the setXBasis/setYBasis/setZBasis methods and instead set the
     ...
     *
     * <p>The z-basis is the orientation of the x-axis, as held by the m20, m21 and m22 properties.
     *
     ...
     *
     * <p>The z-basis is the orientation of the z-axis, as held by the m20, m21 and m22 properties.
     *
     * <p>This method is provided to allow for interoperability for users who do not want to use the
     * {@link Vec3f} class.
     *
     ...
     * <p>The z-basis is the orientation of the z-axis, as held by the m20, m21 and m22 properties.
     *
     * <p>To ensure the legality of the z-basis, the provided Vec3f is normalised if required before
     * being set. If you wish to use this class for storing matrices which do not represent a
     * rotation matrix then you should avoid the setXBasis/setYBasis/setZBasis methods and instead
     * set the matrix properties via other methods which do not enforce normalisation such as the
     ...
     * <p>The z-basis is the orientation of the z-axis, as held by the m20, m21 and m22 properties.
     *
     * <p>To ensure the legality of the z-basis, the provided array is converted into a Vec3f and
     * normalised (if required) before being set.
     *
     * <p>If you wish to use this class for storing matrices which do not represent a rotation
     * matrix then you should avoid the setXBasis/setYBasis/setZBasis methods and instead set the
     ...
     *
     * @return A Vec3f of the origin location of this Mat4f, as stored in the m30, m31 and m32
     *     properties.
     */
     ...
     *
     * <p>The origin is stored in the matrix properties m30 (x location), m31 (y location) and m32
     * (z location).
     *
     * <p>As the origin may be at any location, as such it is <em>not</em> normalised before being
     * set.
     *
    ...
    /**
     * Return whether or not all three axes of this Mat4f are orthogonal (i.e. at 90 degrees to each
     * other).
     *
     * <p>Any two axes, such as x/y, x/z or y/z will be orthogonal if their dot product is zero.
     * However, to account for floating point precision errors, this method accepts that two axes
     * are orthogonal if their dot product is less than or equal to 0.01f.
     *
     * <p>If you want to find out if any two specific axes are orthogonal, then you can use code
     * similar to the following:
     *
     * <p>{@code boolean xDotYOrthogonal = Math.abs( xAxis.dot(yAxis) ) <= 0.01f;}
     *
    ...
    public boolean isOrthogonal() {
        ...
        // If two axes are orthogonal then their dot product will be zero (or approximately zero in
        // this case).
        // Note: We could have picked y/x, z/x, z/y but it's the same thing - they're either
        // orthogonal or they're not.
     ...
     *
     * <p><strong>This</strong> Mat4f is transposed, not a copy.
     *
     * <p>If you want to return a transposed version of a Mat4f <em>without modifying</em> the
     * source then use the {@link #transposed()} method instead.
     *
     ...
     *
     * <p>This Mat4f is <strong>not</strong> modified during the transposing process.
     *
     * <p>If you want to transpose 'this' Mat4f rather than return a transposed copy then use the
     ...
     *
     * <p>Neither this matrix or the provided matrix argument are modified by the multiplication
     * process, instead a new Mat4f containing the resulting matrix is returned.
     *
     * <p>Matrix multiplication is <strong>not commutative</strong> (i.e. {@code AB != BA} - that
     * is, the result of multiplying matrix A by matrix B is <em>not</em> the same as multiplying
     * matrix B by matrix A). As such, to construct a ModelView or ModelViewProjection matrix you
     * must specify them in that precise order <strong>reversed</strong> (because of the order in
     * which the calculations take place), for example:
     *
     * <p>{@code Mat4f modelViewMatrix = viewMatrix.times(modelMatrix); }
     *
     * <p>{@code Mat4f modelViewProjectionMatrix =
     * projectionMatrix.times(viewMatrix).times(modelMatrix); }
     *
     * <p>Although matrix multiplication is <strong>not</strong> commutative, it <strong>is</strong>
     * associative (i.e. {@code A(BC) == (AB)C}), so you can quite happily combine matrices like
     * this:
     *
     * <p>{@code Mat4f modelViewMatrix = viewMatrix.times(modelMatrix); }
     *
     * <p>{@code Mat4f modelViewProjectionMatrix = projectionMatrix.times(modelViewMatrix); }
     *
    ...
    public Mat4f times(Mat4f m) {
        ...
        // Note: This multiplication cannot be performed 'inline' on the same object, hence the need
        // to
     ...
     *
     * <p>This method multiplies the provided Vec3f by this matrix. This is commonly used to
     * transform vertices between coordinate spaces, for example you might multiply a vertex
     * location by a model matrix to transform the vertex from model space into world space.
     *
     * <p>The difference between this method and the {@link #transformDirection} method is that this
     * method takes the origin of this Mat4f into account when performing the transformation, whilst
    ...
    public Vec3f transformPoint(Vec3f v) {
        ...
        result.x =
                this.m00 * v.x
                        + this.m10 * v.y
                        + this.m20 * v.z
                        + this.m30; // * 1.0f; - no need as w is 1.0 for a location
        result.y =
                this.m01 * v.x
                        + this.m11 * v.y
                        + this.m21 * v.z
                        + this.m31; // * 1.0f; - no need as w is 1.0 for a location
        result.z =
                this.m02 * v.x
                        + this.m12 * v.y
                        + this.m22 * v.z
                        + this.m32; // * 1.0f; - no need as w is 1.0 for a location

        return result;
    }

    /**
     * Transform a direction in 3D space taking into account the orientation of this Mat4fs x/y/z
     * axes.
     *
     * <p>The difference between this method and the {@link #transformPoint} method is that this
     * method does not take the origin of this Mat4f into account when performing the
     * transformation, whilst transformPoint does.
     *
    ...
    public Vec3f transformDirection(Vec3f v) {
        ...
        result.x =
                this.m00 * v.x
                        + this.m10 * v.y
                        + this.m20 * v.z; // + this.m30 * 0.0; - no need as w is 0.0 for a direction
        result.y =
                this.m01 * v.x
                        + this.m11 * v.y
                        + this.m21 * v.z; // + this.m31 * 0.0; - no need as w is 0.0 for a direction
        result.z =
                this.m02 * v.x
                        + this.m12 * v.y
                        + this.m22 * v.z; // + this.m32 * 0.0; - no need as w is 0.0 for a direction
     ...
     *
     * <p>Only matrices which do not have a {@link #determinant()} of zero can be inverted. If the
     * determinant of the provided matrix is zero then an IllegalArgumentException is thrown.
     *
    ...
    public static Mat4f inverse(Mat4f m) {
        ...
        // As we cannot divide by zero, we will throw an IllegalArgumentException if the determinant
        // is zero.
        if (Float.compare(determinant, 0.0f) == 0) {
            throw new IllegalArgumentException(
                    "Cannot invert a matrix with a determinant of zero.");
        }

        // Otherwise, calculate the value of one over the determinant and scale the matrix by that
        // value
     ...
     *
     * <p>The changes made are to <strong>this</strong> Mat4f, in the coordinate space of this
     * matrix.
     *
     ...
     *
     * <p>The changes made are to <strong>this</strong> Mat4f.
     *
     ...
     *
     * <p>By a 'local' axis we mean that for example, if you rotated this matrix about the positive
     * X-axis (1,0,0), then rotation would occur around the positive X-axis of <strong>this
     * matrix</strong>, not the <em>global / world-space</em> X-axis.
     *
     ...
     *
     * <p>The cardinal 'world-space' axes are defined so that the +X axis runs to the right, the +Y
     * axis runs upwards, and the +Z axis runs directly outwards from the screen.
     *
     * @param angleRads The angle to rotate the matrix in radians.
     ...
     *
     * <p>The matrix provided is NOT modified - a rotated version is returned.
     *
     * <p>The axis specified to rotate the matrix about is <strong>not</strong> specified in the
     * coordinate space of the matrix being rotated - it is specified in global coordinates, such as
     * used in OpenGL world space. In this coordinate system:
     *
     * <ul>
     *   <li>The positive X-axis runs to the right (1,0,0),
     *   <li>The positive Y-axis runs vertically upwards (0,1,0), and
     *   <li>The positive Z-axis runs outwards from the screen (0,0,1).
     * </ul>
     *
     ...
     *
     * <p>The matrix is rotated about the provided axis in the coordinate system of the provided
     * matrix.
     *
     * @param matrix The matrix to rotate.
     ...
     */
    public static Mat4f rotateMatrixAboutLocalAxisRads(
            Mat4f matrix, float angleRads, Vec3f localAxis) {
     ...
     * @return A rotated matrix.
     */
    public static Mat4f rotateMatrixAboutLocalAxisDegs(
            Mat4f matrix, float angleDegs, Vec3f localAxis) {
        return matrix;
    }
     ...
     *
     * <p>The x, y and z axes are returned in the Mat3f, while the w component of each axis and the
     * origin plus it's w component are discarded.
     *
     * <p>In effect, we are extracting the orientation of this Mat4f into a Mat3f.
     *
     * @return A Mat3f version of this Mat4f.
     */
     ...
     *
     * <p>The matrix values are formatted to three decimal places. If you require the exact
     * unformatted m<em>XY</em> values then they may be accessed directly.
     *
     ...
     *
     * <p>Orthographic projections are commonly used when working in 2D or CAD scenarios. As
     * orthographic projection does not perform foreshortening on any projected geometry, objects
     * are drawn the same size regardless of their distance from the camera.
     *
     * <p>By specifying the bottom clipping plane to be 0.0f and the top clipping plane to be the
     * height of the window, the origin of the coordinate space is at the bottom-left of the window
     * and the positive y-axis runs upwards. To place the origin at the top left of the window and
     * have the y-axis run downwards, simply swap the top and bottom values.
     *
     * <p>Once you have an orthographic projection matrix, if you are not using any separate Model
     * or View matrices then you may simply use the orthographic matrix as a ModelViewProjection
     * matrix.
     *
     * <p>If values are passed so that (right - left), (top - bottom) or (far - near) are zero then
     ...
     * @see <a
     *     href="http://www.songho.ca/opengl/gl_projectionmatrix.html#ortho">http://www.songho.ca/opengl/gl_projectionmatrix.html#ortho</a>
     */
    public static Mat4f createOrthographicProjectionMatrix(
     ...
     *
     * <p>The parameters provided are the locations of the left/right/top/bottom/near/far clipping
     * planes.
     *
     * <p>There is rarely any need to specify the bounds of a projection matrix in this manner, and
     * you are likely to be better served by using the {@link
     * #createPerspectiveProjectionMatrix(float, float, float, float)} method instead.
     *
     * <p>Once you have a Projection matrix, then it can be combined with a ModelView or separate
     * Model and View matrices in the following manner (be careful: multiplication order is
     * important) to create a ModelViewProjection matrix:
     *
     * <p>{@code Mat4f mvpMatrix = projectionMatrix.times(modelViewMatrix);}
     *
     * <p>or
     *
     * <p>{@code Mat4f mvpMatrix = projectionMatrix.times(viewMatrix).times(modelMatrix);}
     *
     * @param left The left clipping plane, typically 0.0f.
     * @param right The right clipping plane, typically the width of the window.
     * @param top The top clipping plane, typically the height of the window.
     ...
     *     href="http://www.songho.ca/opengl/gl_projectionmatrix.html#ortho">http://www.songho.ca/opengl/gl_projectionmatrix.html#ortho</a>
     */
    public static Mat4f createPerspectiveProjectionMatrix(
            float left, float right, float top, float bottom, float near, float far) {
     ...
     */
    public static Mat4f createPerspectiveProjectionMatrix(
            float vertFoVDegs, float aspectRatio, float zNear, float zFar) {
        // Sanity checking
        if (aspectRatio < 0.0f) {
        ...
        if (vertFoVDegs < 1.0f || vertFoVDegs > 179.0f) {
            throw new IllegalArgumentException(
                    "Vertical FoV must be within 1 and 179 degrees inclusive.");
        }
