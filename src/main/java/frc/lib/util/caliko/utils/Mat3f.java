 ...
 * A custom 3x3 matrix.
 *
 * <p>Elements of this Mat3f class are: m00 m10 m20 m01 m11 m21 m02 m12 m22
 *
 * <p>Matrices can be considered as are column-major - although when treating them as arrays this
 * makes no difference.
 *
 * <p>mXX properties are publicly accessible for performance reasons.
 *
 * @author Al Lansley
...
public class Mat3f {
    ...
    public Mat3f() {
        /* Java implicitly sets float primitives to 0.0f on creation */
    }

    /**
     * Constructor which sets the given value across the diagonal and zeroes the rest of the matrix.
     *
     * <p>So for example to create an identity matrix you could just call: Mat3f m = new
     * Mat3f(1.0f).
     *
     * @param value The value to set across the diagonal of the constructed matrix (i.e. elements
     *     m00, m11, and m22).
     */
    public Mat3f(float value) {
        ...
        // All other mXX properties are implicitly set to zero by Java as that is the default value
        // of a float primitive.
    }
     ...
     *
     * <p>The reference direction is aligned to the Z-Axis, and the X-Axis is generated via the
     * genPerpendicularVectorQuick() method. The Y-Axis is then the cross-product of those two axes.
     *
     * <p>This method uses the <a href="https://gist.github.com/roxlu/3082114">Frisvad technique</a>
     * for generating perpendicular axes.
     *
     ...
     * Create a rotation matrix from a given direction.
     *
     * <p>The reference direction is aligned to the Z-Axis. Note: The singularity is on the positive
     * Y-Axis.
     *
     * <p>This method uses the <a href="https://gist.github.com/roxlu/3082114">Frisvad technique</a>
     * for generating perpendicular axes.
    ...
    public static Mat3f createRotationMatrix(Vec3f referenceDirection) {
        ...
        if (Math.abs(referenceDirection.y) > 0.9999f) {
            ...
            rotMat.setYBasis(
                    Vec3f.crossProduct(rotMat.getXBasis(), rotMat.getZBasis()).normalised());
        } else {
            rotMat.setZBasis(referenceDirection);
            rotMat.setXBasis(
    ...
    /**
     * Return whether this matrix consists of three orthogonal axes or not to within a cross-product
     * of 0.01f.
     *
    ...
    /**
     * Multiply this matrix by another matrix (in effect, combining them) and return the result as a
     * new Mat3f.
     *
     * <p>Neither this matrix or the provided matrix argument are modified by this process - you
     * must assign the result to your desired combined matrix.
     *
     * <p>To create a ModelView matrix using this method you would use
     * viewMatrix.times(modelMatrix). To create a ModelViewProjection matrix using this method you
     * would use projectionMatrix.times(viewMatrix).times(modelMatrix).
     *
     ...
     * @param rotationAxis The axis to rotate this matrix about, relative to the current
     ...
     * @param localAxis The axis to rotate this matrix about, relative to the current configuration
     *     of this matrix.
     * @return The rotated version of this matrix.
     */
    public Mat3f rotateDegs(float angleDegs, Vec3f localAxis) {
        return this.rotateRads(localAxis, angleDegs * DEGS_TO_RADS);
    }
